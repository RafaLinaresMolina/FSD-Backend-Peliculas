...
/* RELATIONAL TABLES */
CREATE TABLE IF NOT EXISTS OrderFilm (
	FilmId integer,
	OrderId integer,
	stock integer,
	PRIMARY KEY(FilmId, OrderId)
);
CREATE TABLE IF NOT EXISTS UserRentFilm (
	id_user INT(10),
	id_film INT(10),
	quantity int(3),
...
CREATE TABLE IF NOT EXISTS ActorAppearFilm (
	id_film INT(10),
	id_actor INT(10),
	PRIMARY KEY (id_film, id_actor)
);
CREATE TABLE IF NOT EXISTS FilmIsGenre (
	id_film INT(10),
	id_genre INT(10),
...
ADD CONSTRAINT FK_Order_Has_Film FOREIGN KEY (OrderId) REFERENCES `Order` (id);
ALTER TABLE OrderFilm
ADD CONSTRAINT FK_Film_Conained_Order FOREIGN KEY (FilmId) REFERENCES Film (id);
ALTER TABLE `Order`
ADD CONSTRAINT FK_Order_Has_User FOREIGN KEY (UserId) REFERENCES `User` (id);
/* DUMMY DATA */
/*    Fantasy    */
INSERT INTO film (
		title,
...
VALUES (
        ...
        con la finalidad de destruirlo. Sin embargo, fuerzas malignas muy poderosas quieren arrebatárselo.",
		3
	);
INSERT INTO film (
		title,
...
VALUES ("Hugo", "Wallace Weaving");
INSERT INTO actor (name, last_name)
VALUES ("Sir Ian", "Murray McKellen");
INSERT INTO actor (name, last_name)
VALUES ("Elijah", "Jordan Wood");
INSERT INTO actor (name, last_name)
VALUES ("Sean", "Michael Astin");
INSERT INTO actor (name, last_name)
VALUES ("Viggo", "Peter Mortensen");
INSERT INTO actor (name, last_name)
VALUES ("Keanu", "Charles Reeves");
INSERT INTO actor (name, last_name)
VALUES ("Laurence", "John Fishburne III");
INSERT INTO actor (name, last_name)
...
VALUES ("aventuras");
INSERT INTO genre (name)
VALUES ("basado en novela");
INSERT INTO genre (name)
VALUES ("cine épico");
/* ACTORS IN FILMS  */
INSERT INTO ActorAppearFilm (id_film, id_actor)
VALUES (1, 1);
INSERT INTO ActorAppearFilm (id_film, id_actor)
VALUES (1, 2);
INSERT INTO ActorAppearFilm (id_film, id_actor)
...
VALUES (6, 8);
/* GENRE IN FILMS  */
INSERT INTO FilmIsGenre (id_film, id_genre)
VALUES (4, 1);
INSERT INTO FilmIsGenre (id_film, id_genre)
VALUES (4, 2);
INSERT INTO FilmIsGenre (id_film, id_genre)
...
VALUES (6, 3);
/* PRICE */
INSERT INTO price (days, euro_perDay)
VALUES (2, 2.5);
INSERT INTO price (days, euro_perDay)
VALUES (6, 2);
INSERT INTO price (days, euro_perDay)
